...
from models.all_code.Cycle.cyclegan import CYCLEGAN
...
# cycleGANAugmentaion(image_path=img_path, xml_path=xml_path, image_save_path=save_path, xml_save_path=save_xml, mode="dir_predict")
