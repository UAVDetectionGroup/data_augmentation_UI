...
from models.all_code.utils import image_resize, plot_bboxes,read_xml,add_xml
...
#     categroy=['gtz', "others", "group", "connection"]
#     CutmixAugmentation(image_path=img_path, xml_path=xml_path, image_save_path=save_path, xml_save_path=save_xml,category=categroy)